    ...
    return (
        <>
            ...
            <div className="service">
                <p>
                    <i>"We find that neither form of student work experience enhances initial recruitment decisions. For a number of candidate subgroups (by education level and occupation type), even an adverse effect is found" (Verhaest et al., 2016).</i>
                </p>
                ...
                <p className="heading-q">
                    <b>Networking and Recruitment Events</b>
                </p>
                ...
                <p className="heading-q">
                    <b>Federal Student Work Experience Program (FSWEP)</b>
                </p>
                <p>FSWEP offers full-time and part-time work opportunities for students in a wide variety of fields including sciences, trades, IT, etc. You can explore the many career paths that are offered by the government.</p>
                <p className="heading-q">
                    <b>STEP Services </b>
                </p>
                ...
                <p>See our career resources to learn more about: </p>
                <ul>
                    <li>
                        <b>Job Search Preparation</b> – Job search tools including cover letters, resumes and interview skills
                    </li>
                    <li>
                        <b>Job Search</b>– Career opportunities for full-time, part-time, contract, or seasonal positions for students, recent graduates and professionals
                    </li>
                </ul>
            </div>
